...
## 变更提案
- 提案名称：octoloop-night-watchdog
- 提案目录：logos/changes/octoloop-night-watchdog/
...
- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/1-product-requirements/core-01-requirements.md`
...
- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/2-product-design/1-feature-specs/core-03-gateway-channels-design.md`
- 目标目录：`logos/resources/prd/2-product-design/1-feature-specs/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 3. deltas/prd/2-product-design/1-feature-specs/core-08-octoloop-watchdog-design.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/2-product-design/1-feature-specs/core-08-octoloop-watchdog-design.md`
- 目标目录：`logos/resources/prd/2-product-design/1-feature-specs/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 4. deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/3-technical-plan/1-architecture/core-01-architecture-overview.md`
...
- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/3-technical-plan/2-scenario-implementation/core-00-scenario-overview.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 6. deltas/prd/3-technical-plan/2-scenario-implementation/core-S06-cron-automation.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/3-technical-plan/2-scenario-implementation/core-S06-cron-automation.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 7. deltas/prd/3-technical-plan/2-scenario-implementation/core-S17-octoloop-night-watchdog.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/3-technical-plan/2-scenario-implementation/core-S17-octoloop-night-watchdog.md`
- 目标目录：`logos/resources/prd/3-technical-plan/2-scenario-implementation/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 8. deltas/prd/3-technical-plan/3-deployment/core-01-deployment-plan.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/prd/3-technical-plan/3-deployment/core-01-deployment-plan.md`
- 目标目录：`logos/resources/prd/3-technical-plan/3-deployment/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 9. deltas/test/core-S17-test-cases.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/test/core-S17-test-cases.md`
- 目标目录：`logos/resources/test/`
- 操作：读取 delta 中的 ADDED / MODIFIED / REMOVED 标记，合并到目标目录中对应的主文档

### 10. deltas/test/smoke/core-S17-smoke-test-cases.md

- Delta 文件：`logos/changes/octoloop-night-watchdog/deltas/test/smoke/core-S17-smoke-test-cases.md`
...
8. 所有变更合并完成后，自动执行 git commit（告知用户，无需确认）：
   git add -A && git commit -m "docs(octoloop-night-watchdog): merge spec deltas"
   然后提示用户：按更新后的规格实现代码，代码完成后运行 `openlogos verify` 验收，验收通过后明确授权执行 `openlogos archive octoloop-night-watchdog`。
