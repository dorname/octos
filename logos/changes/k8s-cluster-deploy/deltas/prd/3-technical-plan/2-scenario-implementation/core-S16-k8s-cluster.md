# Delta: prd/3-technical-plan/2-scenario-implementation — core-S16-k8s-cluster.md

> target: logos/resources/prd/3-technical-plan/2-scenario-implementation/core-S16-k8s-cluster.md(全新文档)

## ADDED — S16: K8s 多副本无状态化部署与故障恢复 — 时序图
