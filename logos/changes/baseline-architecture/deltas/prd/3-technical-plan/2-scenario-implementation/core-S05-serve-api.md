# Delta: prd/3-technical-plan/2-scenario-implementation — core-S05-serve-api.md

> target: logos/resources/prd/3-technical-plan/2-scenario-implementation/core-S05-serve-api.md(全新文档)

## ADDED — S05: REST API 服务与流式集成 — 时序图
