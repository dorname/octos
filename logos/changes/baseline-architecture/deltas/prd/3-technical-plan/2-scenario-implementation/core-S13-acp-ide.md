# Delta: prd/3-technical-plan/2-scenario-implementation — core-S13-acp-ide.md

> target: logos/resources/prd/3-technical-plan/2-scenario-implementation/core-S13-acp-ide.md(全新文档)

## ADDED — S13: ACP 协议接入 IDE — 时序图（主路径）
