# Delta: prd/2-product-design/2-page-design — core-02-cli-onboarding-terminal.md

> target: logos/resources/prd/2-product-design/2-page-design/core-02-cli-onboarding-terminal.md(全新文档)

## ADDED — core-02 CLI 上手与对话 终端交互原型
