# Delta: prd/2-product-design/1-feature-specs — core-07-k8s-cluster-design.md

> target: logos/resources/prd/2-product-design/1-feature-specs/core-07-k8s-cluster-design.md(全新文档)

## ADDED — core-07 K8s 集群无状态化 — 功能规格
