# Delta: prd/3-technical-plan/2-scenario-implementation — core-S02-first-run.md

> target: logos/resources/prd/3-technical-plan/2-scenario-implementation/core-S02-first-run.md(全新文档)

## ADDED — S02: 开发者首次上手与认证 — 时序图
